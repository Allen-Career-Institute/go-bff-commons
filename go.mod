...
require (
	github.com/Allen-Career-Institute/common-protos v1.11.28
	github.com/Allen-Career-Institute/go-kratos-commons v1.3.4
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/appconfigdata v1.18.5 // indirect
